...
**************************************************************/
void bwsolve2(mwSize n, double *Ut, mwIndex *irUt, mwIndex *jcUt, 
              double *b, double *x)
...
**************************************************************/
void fwsolve2(mwSize n, double *U, mwIndex *irU, mwIndex *jcU, 
              double *b, double *x)
                  ...
                  const int nrhs, const mxArray *prhs[])
{
   ...
   mwSize      n, isspb, isspU; 
   mwSize      k, kend, options;   
