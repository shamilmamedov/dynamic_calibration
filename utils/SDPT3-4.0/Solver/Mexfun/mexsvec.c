...
* into a column vector 
**********************************************************/
void svec1cmp(mwSize n, double r2, 
           double *A, mwIndex *irA, mwIndex *jcA, mwSize isspA, 
           double *B, mwIndex *irB, mwIndex *jcB, mwSize isspB,
           double *AI, double *BI) 
...
* column-wise into a column vector
**********************************************************/
void svec2cmp(mwSize n, mwSize numblk, mwIndex *cumblksize, mwIndex *blknnz, 
           double r2, 
           double *A, mwIndex *irA, mwIndex *jcA, mwSize isspA, 
           double *B, mwIndex *irB, mwIndex *jcB, mwSize isspB,
           double *AI, double *BI) 
...
* into a column vector
**********************************************************/
void svec3cmp(mwSize n, double r2, 
           double *A, mwIndex *irA, mwIndex *jcA, mwSize isspA, 
           double *B, mwIndex *irB, mwIndex *jcB, mwSize isspB,
           double *AI, double *BI) 
...
* row-wise into a column vector
**********************************************************/
void svec4cmp(mwSize n, mwSize numblk, mwIndex *cumblksize, mwIndex *blknnz, 
           double r2, 
           double *A, mwIndex *irA, mwIndex *jcA, mwSize isspA, 
           double *B, mwIndex *irB, mwIndex *jcB, mwSize isspB,
           double *AI, double *BI) 
...
{    mxArray  *blk_cell_pr;
     ...
     mwSize    mblk, isspA, isspB, iscmpA;
