...
* form Q using the upper triangular part
**********************************************************/
void symcmp(double *Q, double *QI, ptrdiff_t  n)
{
   ptrdiff_t  j, k, jn, kn; 
...
void smat1(ptrdiff_t  n, const double ir2, 
           const double *A, const ptrdiff_t  *irA, const ptrdiff_t  *jcA, ptrdiff_t  isspA, 
...
* multiple sub-blocks 
**********************************************************/
void smat2(ptrdiff_t  n, const ptrdiff_t  numblk, const ptrdiff_t  *cumblksize, const ptrdiff_t  *blknnz, 
           const double ir2, 
           const double *A, const ptrdiff_t  *irA, const ptrdiff_t  *jcA, ptrdiff_t  isspA, 
           ptrdiff_t  mA, ptrdiff_t  colidx, 
           double *B, ptrdiff_t  *irB, ptrdiff_t  *jcB, ptrdiff_t  isspB)
...
* single block 
**********************************************************/
void smat1cmp(ptrdiff_t  n, const double ir2, 
           const double *A, const ptrdiff_t  *irA, const ptrdiff_t  *jcA, ptrdiff_t  isspA, 
           ptrdiff_t  mA, ptrdiff_t  colidx, 
           double *B, ptrdiff_t  *irB, ptrdiff_t  *jcB, ptrdiff_t  isspB,
           double *AI, double *BI)

{  ptrdiff_t   idx, i, j, r, jn, k, kstart, kend, idxj, j2, count, ind;
   double tmp, tmp2;  
   double hf=0.5; 
...
* multiple sub-blocks 
**********************************************************/
void smat2cmp(ptrdiff_t  n, const ptrdiff_t  numblk, const ptrdiff_t  *cumblksize, const ptrdiff_t  *blknnz, 
           const double ir2, 
           const double *A, const ptrdiff_t  *irA, const ptrdiff_t  *jcA, ptrdiff_t  isspA, 
           ptrdiff_t  mA, ptrdiff_t  colidx, 
           double *B, ptrdiff_t  *irB, ptrdiff_t  *jcB, ptrdiff_t  isspB,
...
{    mxArray  *rhs[2]; 
     ...
     ptrdiff_t     mblk, mA, nA, m1, n1, rowidx, colidx, isspA, isspB;
     ptrdiff_t     iscellA, iscmpA; 
